...
# If a link changes next year, just swap it here.
LINKS = {
...
@app.route('/')
def home():
    # We pass the 'LINKS' dictionary to the HTML template
